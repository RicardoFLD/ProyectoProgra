...
def genevaControl():
    ...
    for i in data:
        ...
        if date.today() in open('dates.txt', 'w'):
            data.pop(data.values(date.today()))
    ...
    def add_habits():
        ...
        if habits != "":
            ...
            data[entry_habits.get()]=finaldate
        else:
            messagebox.showwarning(title="Warning!", message="You must enter a habits.")
    ...
    def delete_habits():
        try:
            ...
            messagebox.showwarning(title="Warning!", message="You must select a habits.")
    ...
    def load_habits():
        try:
            ...
            messagebox.showwarning(title="Warning!", message="Cannot find habits.dat.")
    ...
    addTask_btn = Button(
        text='Añadir tarea', width=10,
        command=newTask
    )
    addTask_btn.place(x="525", y="600")

    delTask_btn = Button(
    text='Eliminar tarea',width=10,
    command=deleteTask
    )
